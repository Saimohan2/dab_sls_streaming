...
The 'dab_sls_streaming' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dab_sls_streaming/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dab_sls_streaming_etl` to your workspace.
